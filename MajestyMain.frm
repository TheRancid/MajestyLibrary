...
Object = "{2AAAB2CE-68EF-11D5-B861-CA5122DE214C}#6.0#0"; "MyPercentBar.ocx"
Begin VB.Form frmMain 
   ...
   ClientTop       =   720
   ClientWidth     =   7815
   Icon            =   "MajestyMain.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   285
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   521
   Begin MyPercentBar.usrPercentBar usrPercent 
      Height          =   315
      Left            =   60
      TabIndex        =   11
      TabStop         =   0   'False
   ...
   Begin VB.CheckBox chkShadows 
      DownPicture     =   "MajestyMain.frx":B30C
      Enabled         =   0   'False
      Height          =   375
      Left            =   540
      Picture         =   "MajestyMain.frx":B47E
      Style           =   1  'Graphical
      TabIndex        =   1
